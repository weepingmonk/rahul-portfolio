    ...
    <section id="certifications" className="relative py-24 md:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          description="Validated expertise from Google and Amazon — the platforms that power modern performance marketing."
        />
            ...
            >
              <GlassCard className="group p-8" hover glow>
                <div className="flex items-start gap-5">
                  <div className="relative flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500/20 to-blue-500/20 border border-white/[0.08]">
                    <Award className="h-7 w-7 text-orange-400" />
                    <span className="absolute -bottom-1 -right-1 rounded-md bg-[#060b14] border border-white/10 px-1.5 py-0.5 text-[9px] font-bold text-orange-300">
                      {cert.badge}
                    </span>
                  </div>
